...
name_plugemu = 'Levi45 Emu Keys V.9.6-r14'
...
def menu(menuid, **kwargs):
    if menuid == 'mainmenu':
        return [('Levi45 Emu Keys Updater', main2, 'Levi45 Emu Keys Updater', 44)]
    else:
        return []
